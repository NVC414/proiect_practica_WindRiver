...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (binding.myOrdersButton != null) { // Check if the ID exists in your layout/binding
            setupButtonFeedback(binding.myOrdersButton);
        }
        if (binding.callSupportButton != null) { // Check if the ID exists in your layout/binding
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (currentUser != null) {
            if (binding.userDetails != null) { // Replace 'userEmailText' with your actual ID in the binding
                binding.userDetails.setText(currentUser.getEmail());
            }
        } else {
            if (binding.userDetails != null) { // Replace 'userEmailText'
                binding.userDetails.setText("Not Logged In");
            }
        }

        // Setup Logout Button using ViewBinding
        if (binding.logout != null) { // Replace 'logoutBtn' with your actual ID in the binding
