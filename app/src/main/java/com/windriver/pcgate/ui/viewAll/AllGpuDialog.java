...
public class AllGpuDialog extends DialogFragment
    ...
    public AllGpuDialog(List<GpuItem> allGpus,
                        GpuAdapter.OnAddToCartClickListener addToCartClickListener)
        {
        ...
        adapter.setOnItemClickListener(item ->
            {
                ...
                intent.putExtra("core_clock",
                        item.getCoreClock() != null ? item.getCoreClock() : "");
                intent.putExtra("boost_clock",
                        item.getBoostClock() != null ? item.getBoostClock() : "");
