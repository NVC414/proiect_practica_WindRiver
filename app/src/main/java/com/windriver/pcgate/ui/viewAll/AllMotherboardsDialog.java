...
public class AllMotherboardsDialog extends DialogFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        MotherboardAdapter adapter = new MotherboardAdapter(allMotherboards,
                R.layout.item_motherboard_grid);
        ...
        adapter.setOnItemClickListener(item ->
            {
                ...
                intent.putExtra("form_factor",
                        item.getFormFactor() != null ? item.getFormFactor() : "");
